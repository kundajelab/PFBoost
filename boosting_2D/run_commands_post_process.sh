...
RESULT_PATH=/srv/persistent/pgreens/projects/boosting/results/
python /users/pgreens/git/boosting_2D/run_post_processing.py --model-path $RESULT_PATH"2015_08_14_hematopoeisis_23K_bindingTFsonly_adt_stable_5iter/load_pickle_data_script.py" --analysis-label hema_CMP_v_Mono --run-margin-score --num-perm 100 --split-prom-enh-dist 0 --margin-score-methods x1,x2 --region-feat-file /srv/persistent/pgreens/projects/boosting/data/hematopoeisis_data/index_files/hema_CMP_v_Mono_peaks.txt --condition-feat-file /srv/persistent/pgreens/projects/boosting/data/hematopoeisis_data/index_files/hema_CMP_v_Mono_cells.txt

### Calculate margin score with subset of data with NULL model
RESULT_PATH=/srv/persistent/pgreens/projects/boosting/results/
python /users/pgreens/git/boosting_2D/run_post_processing.py --model-path $RESULT_PATH"2015_08_15_hematopoeisis_23K_bindingTFsonly_adt_stable_1000iter/load_pickle_data_script.py" --analysis-label hema_CMP_v_Mono_NULL_model --run-margin-score --num-perm 1000 --split-prom-enh-dist 0 --margin-score-methods x1,x2,path,node --region-feat-file /srv/persistent/pgreens/projects/boosting/data/hematopoeisis_data/index_files/hema_CMP_v_Mono_peaks.txt --condition-feat-file /srv/persistent/pgreens/projects/boosting/data/hematopoeisis_data/index_files/hema_CMP_v_Mono_cells.txt --null-tree-model  $RESULT_PATH"2015_08_17_hematopoeisis_23K_bindingTFsonly_NULL_adt_stable_1000iter/saved_tree_state__2015_08_17_hematopoeisis_23K_bindingTFsonly_NULL_adt_stable_1000iter.gz"

### TADPOLE: Calculate margin score with subset of data with NULL model
RESULT_PATH=/srv/persistent/pgreens/projects/boosting/results/
python /users/pgreens/git/boosting_2D/run_post_processing.py --model-path $RESULT_PATH"2015_08_31_tadpole_tail_3K_adt_stable_1000iter/load_pickle_data_script.py" --run-margin-score --num-perm 100 --margin-score-methods x1,x2,path,node --analysis-label tadpole_full_model  --region-feat-file /srv/persistent/pgreens/projects/boosting/data/tadpole_data/index_files/temp_regions.txt --condition-feat-file /srv/persistent/pgreens/projects/boosting/data/tadpole_data/index_files/temp_conditions.txt

### COmpute margin score with ChipSeq peaks  
RESULT_PATH=/srv/persistent/pgreens/projects/boosting/results/
python /users/pgreens/git/boosting_2D/run_post_processing.py --model-path $RESULT_PATH"2015_08_15_hematopoeisis_23K_bindingTFsonly_adt_stable_1000iter/load_pickle_data_script.py" --analysis-label hema_MPP_HSC_v_pHSC_K562_GATA1_ChipSeq_peaks --run-margin-score --num-perm 5 --margin-score-methods x1,x2 --region-feat-file /srv/persistent/pgreens/projects/boosting/results/2015_08_15_hematopoeisis_23K_bindingTFsonly_adt_stable_1000iter/chip_seq/peak_headers_full_subset_CD34_K562_Gata1_intersect.txt --condition-feat-file /srv/persistent/pgreens/projects/boosting/data/hematopoeisis_data/index_files/hema_MPP_HSC_v_pHSC_cells.txt 
...
RESULT_PATH=/srv/persistent/pgreens/projects/boosting/results/
python /users/pgreens/git/boosting_2D/bin/run_post_processing.py --model-path $RESULT_PATH"2015_08_15_hematopoeisis_23K_bindingTFsonly_adt_stable_1000iter/load_pickle_data_script.py" --run-unsupervised-clustering --n-clusters-start 10000 --features-to-use motif --clusters-to-write 10,11,12

### Return example by feature matrix
###############################################################

cell_file='/srv/persistent/pgreens/projects/boosting/data/hematopoeisis_data/index_files/hema_MEP_v_Ery_cells.txt'
peak_file='/srv/persistent/pgreens/projects/boosting/results/2015_08_15_hematopoeisis_23K_bindingTFsonly_adt_stable_1000iter/chip_seq/peak_headers_full_subset_CD34_K562_GATA1_intersect.txt'
RESULT_PATH=/srv/persistent/pgreens/projects/boosting/results/
python /users/pgreens/git/boosting_2D/bin/run_post_processing.py --model-path $RESULT_PATH"2015_08_15_hematopoeisis_23K_bindingTFsonly_adt_stable_1000iter/load_pickle_data_script.py" --return-ex-by-feat-matrix  --features-to-use motif \
     --region-feat-file $peak_file --condition-feat-file $cell_file --analysis-label "MEP_Ery_cells__GATA1_peaks"
