...
rna_matrix_file=paste(c(DATA_PATH,'data/rna_seq/merged_matrix/gene_level_tpm.txt'), collapse="")
...
# subset to that list of regulators
...
for (comp in comparisons[,1]){
	...
	grp1_samples = rna_annots$sample_name[rna_annots$cell_type %in% grp1_labels]
	grp2_samples = rna_annots$sample_name[rna_annots$cell_type %in% grp2_labels]
