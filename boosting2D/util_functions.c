...
/* "boosting_2D/util_functions.pyx":12
 * # x is weights_i
 ...
 */
  ...
  /* "boosting_2D/util_functions.pyx":15
 *     # find all non-zero entries
 *     cdef float sum_squared_values = 0
 *     cdef float sum_values = 0             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t i
 ...
 */
  ...
  /* "boosting_2D/util_functions.pyx":22
 *         sum_squared_values += value*value
 *         sum_values += value
 *     return np.sqrt(sum_squared_values/(sum_values**2))             # <<<<<<<<<<<<<<
 */
  ...
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_5 = PyFloat_FromDouble((__pyx_v_sum_squared_values / __pyx_t_7)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_8 = NULL;
  ...
  if (!__pyx_t_8) {
    ...
    __pyx_t_5 = 0;
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_9, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
 ...
 *     cdef float sum_squared_values = 0
 */
  __pyx_tuple__7 = PyTuple_Pack(5, __pyx_n_s_x, __pyx_n_s_sum_squared_values, __pyx_n_s_sum_values, __pyx_n_s_i, __pyx_n_s_value); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef float sum_squared_values = 0
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_11boosting_2D_14util_functions_1calc_sqrt_sum_sqr_sqr_sums, NULL, __pyx_n_s_boosting_2D_util_functions); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_calc_sqrt_sum_sqr_sqr_sums, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
